...
def convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        e11_p = [i for i, t in enumerate(tokens_a) if t == "<e1>"]
        e12_p = [i for i, t in enumerate(tokens_a) if t == "</e1>"]
        assert len(e11_p) == len(e12_p)
        e21_p = [i for i, t in enumerate(tokens_a) if t == "<e2>"]
        e22_p = [i for i, t in enumerate(tokens_a) if t == "</e2>"]
